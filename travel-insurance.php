...
<head>
		...
		<title>PROWEALTH Insurance | Travel Insurance</title>	
		...
		<?php include'header.php'; ?>
			...
			<section class="page-header page-header-modern page-header-background page-header-background-md parallax my-0" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="img/travel.jpg">
				<div class="container">
					<div class="row">
						<div class="col-md-12 align-self-center p-static order-2 text-center">
							<h1 class="custom-primary-font text-11 font-weight-light">Travel Insurance</h1>
						</div>
					</div>
				</div>
			</section>

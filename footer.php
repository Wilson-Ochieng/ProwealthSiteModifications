            ...
            <div style="background: #eaeaea;" class="container">
                ...
                <div class="row py-5 my-4">
                    <!-- <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                        ...
                        <p class="pr-1">We would love to hear from you
Interested in working with us?
Shoot us an email or request a quote on
the homepage</p>
                        ...
                        <form id="newsletterForm" action="https://preview.oklerthemes.com/porto/8.0.0/php/newsletter-subscribe.php" method="POST" class="mr-4 mb-3 mb-md-0">
                            <div class="input-group input-group-rounded">
                                <input class="form-control form-control-sm bg-light" placeholder="Email Address" name="newsletterEmail" id="newsletterEmail" type="text"> <span class="input-group-append">                                     <button class="btn btn-light text-color-dark" id="go_btn"><strong>GO!</strong></button>                                   </span> </div>
                        </form>
                    </div> -->
                   <!--  <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                         <div class="contact-details">
                            <h5 class="text-3 mb-3">More Info</h5>
                            <ul class="list list-icons list-icons-lg">
                                <li class="mb-1"><i class="fas fa-angle-right"></i>
                                   <a href="term_conditions.php" class="ml-1 text-decoration-none">Terms and Conditions</a>
                                </li>
                                 <li class="mb-1"><i class="fas fa-angle-right"></i>
                                   <a href="privacy_policy.php" class="ml-1 text-decoration-none">Privacy Policy</a>
                                </li>
...
var form_data = new FormData(document.querySelector('#get_quote_form'));



            $.ajax({
                       url: "php_mail/vendor/mail.php",
                  type: "POST",
                  data:  form_data,
                  contentType: false,
                       cache: false,
...
var form_data = new FormData(document.querySelector('#contactForm'));

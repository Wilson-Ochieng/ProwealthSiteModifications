...
<head>
		...
		<title>PROWEALTH Insurance | Wealth Insurance</title>	
		...
		<?php include'header.php'; ?>
			...
			<section class="page-header page-header-modern page-header-background page-header-background-md parallax my-0" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="img/wealth-1.jpg">
				<div class="container">
					<div class="row">
			...
			<section class="section bg-color-light custom-padding-3 border-0 my-0">
				<div class="container">
					...
					<div class="row mb-5">
						<div class="col">
							<img class="float-left img-fluid mr-4 mb-3 mt-2 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="600" width="350" src="img/wealth-2.jpg" alt="">
							<p class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">Your eggs in different baskets... watch as they hatch!</p>
